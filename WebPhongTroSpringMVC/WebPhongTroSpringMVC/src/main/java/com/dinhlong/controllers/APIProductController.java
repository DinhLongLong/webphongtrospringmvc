...
public class APIProductController {
    ...
    public ResponseEntity<List<Product>> productsByUserId(@PathVariable String userId) {
        int pageIndex = 2;
        List<Product> products = this.productService.getProductsByUserId(Integer.parseInt(userId), pageIndex);
